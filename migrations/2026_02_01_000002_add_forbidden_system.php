...
function sp_migrate_2026_02_01_000002_add_forbidden_system() {
    global $wpdb;
    ...
    $column_exists = $wpdb->get_results("SHOW COLUMNS FROM {$events_table} LIKE 'forbidden_enabled'");
    
    if (empty($column_exists)) {
        $wpdb->query("ALTER TABLE {$events_table} ADD COLUMN `forbidden_enabled` TINYINT(1) DEFAULT 0 AFTER `is_mandatory`");
    }
...
// Run migration
sp_migrate_2026_02_01_000002_add_forbidden_system();
