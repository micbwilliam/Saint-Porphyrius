...
<div class="sp-app-content">
    ...
    <div class="sp-pending-page">
        ...
        <p class="sp-pending-message">
            ابن/بنت برفوريوس! تم استلام طلبك بنجاح 🙏
            <br><br>
            سيتم مراجعة طلب انضمامك لأسرة القديس برفوريوس لخدمة القرى وسنقوم بإرسال رسالة إلى بريدك الإلكتروني فور الموافقة.
            <br><br>
            بركة صلوات القديس برفوريوس تكون معاك! ⛪
        </p>
    ...
    <footer class="sp-footer">
        <p>© <?php echo date('Y'); ?> أسرة القديس برفوريوس - جميع الحقوق محفوظة</p>
    </footer>
</div>
