...
class SP_Gamification {
    ...
    private function get_service_instructions_content() {
        return <<<INSTRUCTIONS
<h3>⛪ نظام الحضور</h3>
<p>نظام الحضور مصمم عشان يساعدنا نكون منتظمين في خدمتنا واجتماعاتنا. لما تحضر فعالية بتكسب نقاط، ولما تتأخر بتاخد نقاط أقل، ولما تغيب من فعالية إلزامية بتخسر نقاط.</p>

<h3>⭐ نظام النقاط</h3>
<p>كل فعالية ليها نقاط محددة حسب نوعها:</p>
<ul>
    <li><strong>الحضور في الوقت:</strong> بتاخد النقاط الكاملة للفعالية</li>
    <li><strong>الحضور متأخر:</strong> بتاخد نقاط أقل من الحضور في الوقت</li>
    <li><strong>الغياب:</strong> لو الفعالية إلزامية، بتخسر نقاط</li>
    <li><strong>العذر المقبول:</strong> لو عندك عذر ومتقدم قبل الفعالية، ممكن ماتخسرش نقاط</li>
</ul>

<h3>⛔ نظام المحروم</h3>
<p>بعض الفعاليات المهمة جداً عليها نظام المحروم. لو غبت من فعالية عليها نظام المحروم بدون عذر مقبول:</p>
<ul>
    <li>بتتحرم من حضور الفعاليات اللي عليها نظام المحروم لفترة معينة</li>
    <li>لازم تحضر فعاليات تانية عشان ترجع</li>
    <li>العذر المقبول لازم يتقدم قبل الفعالية مش بعدها</li>
</ul>

<h3>🙋 تسجيل الحضور المتوقع</h3>
<p>قبل أي فعالية تقدر تسجل إنك ناوي تحضر. ده بيساعدنا نجهز المكان ونعرف عدد الحاضرين المتوقع.</p>

<h3>📱 رمز QR للحضور</h3>
<p>يوم الفعالية هيظهرلك زرار لعمل رمز QR. الخادم هيسكن الرمز ده عشان يثبت حضورك. الرمز صالح لمدة 5 دقايق بس وبعدين بيتغير عشان الأمان.</p>

<h3>📝 تقديم الأعذار</h3>
<p>لو مش هتقدر تحضر فعالية إلزامية:</p>
<ul>
    <li>قدم عذرك قبل الفعالية من صفحة الفعالية</li>
    <li>اكتب السبب بوضوح</li>
    <li>الخادم هيراجع العذر ويرد عليك</li>
    <li>العذر المقبول بيحميك من خصم النقاط ونظام المحروم</li>
</ul>

<h3>🏆 المتصدرين</h3>
<p>صفحة المتصدرين بتعرض أكتر الأعضاء نشاطاً وحضوراً. كل ما حضرت أكتر، كل ما ترتيبك يعلى!</p>

<h3>💡 نصائح مهمة</h3>
<ul>
    <li>سجل حضورك المتوقع قبل كل فعالية</li>
    <li>احضر في الوقت عشان تاخد النقاط الكاملة</li>
    <li>قدم عذرك مبكراً لو مش هتقدر تحضر</li>
    <li>راجع صفحة النقاط عشان تعرف رصيدك</li>
</ul>
INSTRUCTIONS;
    }
