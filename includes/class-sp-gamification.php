...
<h3>🎭 حياته كبهلوان</h3>
<p>عمل برفوريوس في مسرح الإسكندرية في عهد الإمبراطور يوليانوس الجاحد (361-363م)، وكان من أشهر الممثلين الذين يسخرون من المسيحيين في عروضهم المسرحية. كان يُقلد طقوس المعمودية والصلوات المسيحية ليُضحك الجماهير الوثنية.</p>

<h3>✝️ معموديته المعجزية</h3>
<p>في أحد العروض، طلب منه الجمهور أن يُقلد سر المعمودية المسيحي. نزل برفوريوس إلى حوض ماء على المسرح، وبدأ يُردد كلمات المعمودية ساخراً. لكن حدثت المعجزة! فبمجرد أن نطق باسم الآب والابن والروح القدس وغطس في الماء، حلّ عليه الروح القدس وانفتحت عيناه الروحية.</p>

<p>خرج من الماء إنساناً جديداً، وصرخ أمام الجميع: <strong>"أنا مسيحي! أنا مسيحي!"</strong></p>

<h3>🔥 إيمانه الراسخ</h3>
<p>لم يستطع الإمبراطور يوليانوس تصديق ما حدث، فاستدعى برفوريوس وحاول إقناعه بالعودة عن إيمانه بالوعود والتهديدات، لكن القديس رفض بثبات قائلاً: "رأيت نوراً عظيماً وسمعت صوتاً من السماء يقول لي: أنت قد اغتسلت ونلت الحياة الأبدية".</p>
...
STORY;
    ...
    public function get_quiz_questions() {
        $questions = array(
            ...
            array(
                'id' => 11,
                'question' => 'في أي مسرح كان يعمل برفوريوس؟',
                'options' => array('مسرح روما', 'مسرح الإسكندرية', 'مسرح أثينا', 'مسرح أنطاكية'),
                'correct' => 1,
            ),
            array(
                'id' => 12,
                'question' => 'ماذا رأى برفوريوس عندما اعتمد؟',
                'options' => array('ملائكة', 'نوراً عظيماً', 'حمامة', 'سحاب'),
                'correct' => 1,
            ),
            array(
                'id' => 13,
                'question' => 'ماذا سمع برفوريوس من السماء؟',
            ...
            array(
                'id' => 29,
                'question' => 'ما هو الشعور الذي ملأ برفوريوس بعد معموديته؟',
                'options' => array('الخوف', 'الغضب', 'الفرح والإيمان', 'الحزن'),
                'correct' => 2,
            ),
            array(
                'id' => 30,
            ...
            array(
                'id' => 35,
                'question' => 'أين يوجد مسرح الإسكندرية الذي عمل فيه برفوريوس؟',
                'options' => array('روما', 'الإسكندرية بمصر', 'اليونان', 'سوريا'),
                'correct' => 1,
            ),
            array(
                'id' => 36,
            ...
            array(
                'id' => 43,
                'question' => 'ما هي الصفة التي وصف بها القديس برفوريوس نفسه بعد المعمودية؟',
                'options' => array('إنسان جديد', 'بهلوان محترف', 'ممثل ماهر', 'خاطئ'),
                'correct' => 0,
            ),
            array(
                'id' => 44,
                'question' => 'كم مرة صرخ برفوريوس "أنا مسيحي"؟',
                'options' => array('مرة واحدة', 'مرتين', 'لم يصرخ', 'لا نعرف'),
                'correct' => 1,
            ),
            array(
                'id' => 45,
